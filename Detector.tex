...
\begin{figure}[!Hhtb]
  ...
  \caption[Sketch of the muon chambers of CMS]{A sketch of the muon chambers of the CMS detector. The are shown in red followed by the . Perpendicular to the beam pipe the are mounted. Taken from~\citen{CMSPlots}. \label{plot:LHCCMSMuonChambersCMS}}
\end{figure}
