...
The Large Hadron Collider (LHC) is a proton proton collider located at CERN close to Geneva at the French-Swiss border. It is a ring accelator build 100\m{} under ground with a circumference of about 27\km{}. The tunnel in which the LHC is placed has already been build for the previous accelerator LEP, an electron positron collider. A sketch of it can be seen in Figure~\ref{plot:LCHSketch}. Furthermore, the SPS as one of the pre accelerators can be seen. From this accelerator the protons are put into the LHC with an energy of 450\GeV{}. The foreseen energy of the LHC itself is 7\TeV{} per proton. During the first runtime of the LHC from 2010 until 2012 the LHC ran first with an energy of 3.5\TeV{} which was increased to 4\TeV{} for the final year. Additionally, at the end of every year the LHC also accelerates lead nuclei. Hence, also protons and lead nuclei or only lead nuclei can be brought to collison. \\
To bend the accelerated protons or lead nuclei superconductiong around 1200 dipole magnets made of Nb-Ti are used. The advanced technology of Rutherford cables provides a magnetic field above 8\unit{T}. This requires a cooling down to temperatures below 2\K{}. To focus the particle bunches in one direction magnets of higher order are used like quadrupole magnets. \\
