...
\begin{table}[h!]
\begin{center}
\caption[Comparison of the signal and pileup efficiency and purity for the different qualities of the association map based on \Zz to \MM events]{The resulting values in $\%$ for efficiency, purity and the product of both for keeping signal tracks and subtracting pileup tracks for the different quality classes of the association map. All values are averaged over the whole parameter range. Since the technique in the third step of the association map does not affect quality six and five only from quality 4 on the values for the different options are shown. This study is based on 25000 events with on average about 450 tracks including 56 signal tracks per event.}
