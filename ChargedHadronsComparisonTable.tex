...
\begin{table}[h]
\begin{center}
\caption{Efficiency, purity and the product of both in $\%$  for preserving signal tracks and subtracting pileup tracks of the different pileup subtraction techniques. Here, only charged hadrons from simulated \ttbar events are considered. All values are averaged over the whole parameter range.}
