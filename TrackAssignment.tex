...
In summary, the association map leads in  most cases to the best performance regarding the combination of efficiency and purity. Only for tracks with a high \pt{} applying no pileup subtraction leads to better results. This difference is mainly because of the association of charged hadrons. For such particle the performance in terms of pileup efficiency and purity \pt{}is better for high , too. For all other cases the association map leads to the best results regarding the performance in subtracting pileup tracks.
