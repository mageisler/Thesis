...
\begin{figure}[!Hhtb]
  ...
  \caption[Instantaneous luminosity at CMS]{The instantaneaous luminosity as delivered to CMS from the LHC accelerator during the proton-proton run period in 2012. Taken from reference~\citen{CMS-Lumi-Public-Webpage}. \label{plot:IntroInstLumi}}
\end{figure}
