...
\newcommand{\ms}{\ensuremath{\,\text{m}^{\text{2}}}\xspace}
\newcommand{\cm}{\ensuremath{\,\text{cm}}\xspace}
\newcommand{\mb}{\ensuremath{\,\text{mb}}\xspace}
\newcommand{\mm}{\ensuremath{\,\text{mm}}\xspace}
\newcommand{\mms}{\ensuremath{\,\text{mm}^{\text{2}}}\xspace}
\newcommand{\fm}{\ensuremath{\,\text{fm}}\xspace}
\newcommand{\gcmc}{\ensuremath{\,\text{g}\hspace{-0.16em}/\hspace{-0.08em}\text{cm}^{\text{3}}}\xspace}
\newcommand{\mus}{\ensuremath{\,\mu\text{s}}\xspace}
\newcommand{\ns}{\ensuremath{\,\text{ns}}\xspace}
\newcommand{\rad}{\ensuremath{\,\text{rad}}\xspace}
\newcommand{\mrad}{\ensuremath{\,\text{mrad}}\xspace}
\newcommand{\murad}{\ensuremath{\,\mu\text{rad}}\xspace}
...
\newcommand{\GBytes}{\ensuremath{{\,\text{GByte\hspace{-0.16em}/\hspace{-0.08em}}\text{s}}}\xspace}
...
\newcommand{\hertzpernbarn}{\ensuremath{\, \text{Hz\hspace{-0.08em}/\hspace{-0.16em}}\text{nb}}\xspace}
%
...
\providecommand{\PgL}{\ensuremath{\Lambda{}}\xspace} % Lambda
...
\providecommand{\PaB}{\ensuremath{\overline{B}}\xspace} % anti B
\providecommand{\PB}{\ensuremath{B}\xspace} % B
...
\newcommand{\pn}[1]{\ensuremath{\sf{#1}}}
\newcommand{\dublett}[2]{$\begin{pmatrix}\pn{#1} \\ \pn{#2}\end{pmatrix}_{\pn{L}}$}
\newcommand{\singlett}[1]{$\begin{array}{c}\pn{\upnu_{#1,R}} \\ \pn{#1_R^-}\end{array}$}
\newcommand{\qsinglett}[2]{$\begin{array}{c}\pn{#1_R} \\ \pn{#2_R}\end{array}$}
\newcommand{\dubarrc}[2]{$\begin{array}{c} #1 \\ #2  \end{array}$}
\newcommand{\dubarrl}[2]{$\hspace{-2ex}\begin{array}{l} #1 \\ #2  \end{array}$}
\newcommand{\dubarrr}[2]{$\begin{array}{r} #1 \\ #2  \end{array}\hspace{-2ex}$}
...
\hyphenation{Mu-on}
\hyphenation{E-gam-ma}
\hyphenation{pi-le-up}

\hyphenation{CMS-Ex-pe-ri-ments}
